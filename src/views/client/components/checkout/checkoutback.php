...
<!-------Costum-------->
<?= $this->asset('css/custom/client/users/checkout/checkout', 'css') ?? ''?>
<?php $this->end(); ?>
<?php $this->start('body'); ?>
<main id="main-site">
   <!-- Content -->
                              ...
                              <table class="table table-borderless">
                                 ...
                                 <tr class="border-bottom address">
                                    ...
                                    <td class="link"><a href="#" class="text-highlight change-ship__btn"
                                          data-bs-toggle="modal" data-bs-target="#modal-box-change-address">Change</a>
                                    </td>
                                 </tr>
                              </table>
                           </div>
                  ...
                  <form action="#" method="post" id="add-address-frm" class="px-3 needs-validation" novalidate
                     ...
                     <div class="row">
                        <div class="mb-3 col-md-6">
                           <input type="text" name="ville" id="chg-ville" class="form-control " placeholder="New City"
                              aria-describedby="chg-ville-feedback">
                     ...
                     <div class="mb-3">
                        <input type="text" name="region" id="chg-region" class="form-control " placeholder="New Region"
                           aria-describedby="chg-region-feedback">
                     ...
                     <div class="mb-3 justify-content-between">
                        <input type="submit" name="submitBtn" id="submitBtnAddress" value="Submit" class="button">
                     </div>
                  </form>
               </div>
            </div>
            ...
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <form action="#" method="post" id="shipping-select-frm" class="px-3 needs-validation" novalidate
                     ...
                     <div id="alertErr"></div>
                     <div class="mb-3">
                        <select type="text" name="shipping_class_change" id="shipping_class_change" class="form-control"
                           style="width: 100%;">
                           <option value=""></option>
                        </select>
                        <div class="invalid-feedback" id="brands-feedback"></div>
                     ...
                     <div class="mb-3 justify-content-between">
                        <input type="submit" name="submitBtn" id="submitBtnShipping" value="Submit" class="button">
                     </div>
                  </form>
               </div>
            </div>
...
<!----------custom--------->
<?= $this->asset('js/custom/client/users/checkout/checkout', 'js') ?? ''?>
<?php $this->end();