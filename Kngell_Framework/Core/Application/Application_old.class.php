...
class Application_old extends AbstractBaseBootLoader
{
    use SystemTrait;
    ...
    public function run() : ResponseHandler
    {
        ...
        return $this->loadRoutes()->resolve();
    }
    ...
    {
        $this->session = !empty($this->appConfig['session']) ? $this->appConfig['session'] : $this->make(SessionConfig::class)->baseConfiguration();
    ...
    {
        return isset($this->appConfig->isSessionGlobal) && $this->isSessionGlobal === true ? true : false;
    }
    ...
    {
        $this->cache = (!empty($this->appConfig['cache']) ? $this->appConfig['cache'] : $this->make(CacheConfig::class)->baseConfiguration());
    ...
    {
        $this->errorHandling = $this->appConfig['error_handler']; //$errorHandling;
